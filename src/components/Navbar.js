      ...
      <nav className="navbar navbar-expand-lg  p-3 mb-5 rounded">
        <a className="navbar-brand food-animate" href="/">
          <span className="app-title">
            <span className="F">Q</span>uick <span className="F">B</span>ite
          </span>
          <img
            ...
            {currentUser ? (
              <>
                <div className="dropdown mt-2 ml-2">
                  <span className="navbar-username" style={{paddingRight:"10px"}}>{currentUser.name}</span>
                  {!Is_Admin && (
                  <a href="/orders" style={{paddingRight:"10px"}}>
                        <FontAwesomeIcon
